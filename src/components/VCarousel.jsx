          ...
          <SwiperSlide key={i}>
            <div className="bg-gray-100 p-4 relative overflow-hidden rounded-xl max-w-[800px] w-full h-auto md:h-[500px] mx-auto">
              ...
              <label className="relative block cursor-pointer">
                {/* Hidden checkbox to trigger mobile click */}
                ...
                <div
                  ...
                  className="group peer-checked:h-[400px] hover:h-[400px] absolute left-1/2 bottom-0 translate-x-[-50%] w-[90%] max-w-[700px] h-[200px] md:h-[200px] bg-gray-300 rounded-xl shadow-md transition-all duration-500 ease-in-out overflow-hidden">
                  {/* 🚄 Train image scales on tap (mobile) or hover (desktop) */}
                  <div className="absolute peer-checked:scale-50 group-hover:scale-50 md:group-hover:scale-125 bg-amber-500 bottom-4 left-1/2 translate-x-[-50%] transition-all duration-500 ease-in-out w-[80px] h-[80px]">
                    <img
                      ...
                      alt=""
                      className="w-10 h-10 md:w-full md:h-full object-contain"
                    />
                  </div>
                  ...
                  <div className="mt-16 p-4 space-y-4 text-center">
                    ...
                    <p className="text-sm px-6">
                      ...
                      residential, commercial, and industrial use. <br />{" "}
