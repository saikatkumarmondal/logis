      ...
      <div className="flex gap-10 p-5 ">
        <div className="">
          ...
          <div>
            <div className="bg-red-500 w-[70px] h-[600px] relative left-150 -top-220 rounded-2xl">
              <p className="text-center text-white text-lg font-bold whitespace-nowrap origin-center transform rotate-90 relative -bottom-45">
        ...
        <div className="">
          ...
          <p className="border-l-4 border-red-500 p-2 ">
            ...
            components like control systems, door operators, and safety gear.
            Our products are built to meet international safety and performance
            standards, ensuring reliability and durability in every
